"""Aethon — Configuration centralisée avec système de Personas."""
...
DEFAULT_CONFIG_PATH = Path(__file__).parent.parent / "aethon_config.json"
...
class AethonConfig:
    ...
    @classmethod
    def from_dict(cls, data: dict) -> "AethonConfig":
    ...
    @classmethod
    def load(cls, path: Path | str | None = None) -> "AethonConfig":
