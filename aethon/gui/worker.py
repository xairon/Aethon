"""QThread worker wrapping AethonPipeline for GUI integration."""
...
class PipelineWorker(QThread):
    """Runs AethonPipeline in a background thread with Qt signals."""
    ...
    def __init__(self, parent=None):
        ...
        self._config: AethonConfig | None = None

    def configure(self, config: AethonConfig):
        self._config = config
