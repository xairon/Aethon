...
from aethon.gui.settings_dialog import SettingsDialog
from aethon.gui.state import PipelineState, STATE_COLORS, STATE_LABELS
...
from aethon.gui.widgets.chat_widget import ChatWidget
from aethon.gui.widgets.level_meter import LevelMeter
from aethon.gui.widgets.orb_widget import OrbWidget
from aethon.gui.widgets.toast import ToastManager


class MainWindow(QMainWindow):
    """Aethon main window with animated orb, chat, and controls."""
    ...
    # ── Public API (called by AethonApp) ──

    def set_config(self, config: AethonConfig):
        self.config = config
