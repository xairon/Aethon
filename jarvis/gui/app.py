"""Jarvis GUI application — QApplication + orchestration."""
...
from jarvis.gui.tray import JarvisTray, _make_icon
from jarvis.gui.worker import PipelineWorker
...
class JarvisApp:
    ...
    def __init__(self, argv: list[str]):
        ...
        if sys.stdout is None or sys.stderr is None:
            ...
            _log_path = os.path.join(_app_dir, "..", "..", "jarvis.log")
        ...
        # Tray
        self.tray = JarvisTray(name=self.config.name)
    ...
    def _save_and_restart(self, new_config: JarvisConfig):
