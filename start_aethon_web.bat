...
start "Aethon Backend" /min "%VENV%\python.exe" "%ROOT%\server\main.py"
...
cd /d "%WEB%"
start "Aethon Frontend" /min npx vite --host 127.0.0.1 --port 5173 --strictPort
